...
import rawEntriesJson from './legacy-pokemon.min.json'
import { PokemonColor, PokemonEntry, PokemonEntryMap, PokemonEntrySearchIndex, RawLegacyPokemonEntry } from './types'

const rawEntries: RawLegacyPokemonEntry[] = fetchRawEntries()
...
function _transformPokemon(pokemon: RawLegacyPokemonEntry): PokemonEntry {
  return {
    ...
    type1: pokemon.type1,
    type2: pokemon.type2,
    color: pokemon.color as PokemonColor,
    shiny: {

...
import { PkBoxGroup } from '@/v3/features/livingdex/components/pkm-box/PkBoxGroup'
...
import { classNameIf } from '@/v3/lib/utils/deprecated'
...
const NationalLivingDexView = () => {
  ...
  if (!dex) {
    return <LoadingBanner content={'Unexpected error. Cannot load the Living Pokédex. Please let us know.'} />
  }

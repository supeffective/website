...
import { GameLabel } from '@/v3/lib/components/GameLabel'
import { ExternLink } from '@/v3/lib/components/Links'
import { TextInput } from '@/v3/lib/components/forms/TextInput'
import { getGameSetById } from '@/v3/lib/data-client/game-sets'
import { PokemonEntry, PokemonEntrySearchIndex } from '@/v3/lib/data-client/pokemon/types'
  ...
  return (
    ...
    >
      ...
      <article className={css.announcement}>
        <p>
          While we continue doing some work here, you can already try out our new Dex Tracker website! It is a super
          fast client-based web app that doesn't require any login.
        </p>
